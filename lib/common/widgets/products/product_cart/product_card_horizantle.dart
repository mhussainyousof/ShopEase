          ...
          child: Stack(
            children: [
              SizedBox(
                height: 120,
                width: 120,
                child: ERoundedImage(imageUrl: TImages.productImage1, applyImageRadius: true),
                ...
                Positioned(
                  ...
                  child: ERoundedContainer(
                    ...
                    child: Text('25%', style: theme.labelLarge!.apply(color: TColors.black),),
                  )),

                  Positioned(
                    top: 0,
                    right: 0,
                    child: ECircularIcon(icon: 
                  Iconsax.heart5, color: Colors.red,
                  ))
